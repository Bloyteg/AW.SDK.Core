...
namespace AW
{
    internal class InterOp
    {
        ...
        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_stringW")]
        public static extern IntPtr aw_string(Attributes a);

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_string_setW")]
        ...
        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_enterW")]
        public static extern int aw_enter(string world);

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true)]
        public static extern int aw_exit();

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_sayW")]
        public static extern int aw_say(string message);

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_whisperW")]
        public static extern int aw_whisper(int session_id, string message);

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true)]
        public static extern int aw_state_change();

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_citizen_attributes_by_nameW")]
        ...
        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_license_attributesW")]
        public static extern int aw_license_attributes(string name);

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true)]
        public static extern int aw_license_change();

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_license_deleteW")]
        ...
        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_url_sendW")]
        public static extern int aw_url_send(int session_id, string url, string target);

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_url_clickW")]
        ...
        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_world_attribute_setW")]
        public static extern int aw_world_attribute_set(int attribute, string value);

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_world_attribute_getW")]
        ...
        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_check_rightW")]
        public static extern bool aw_check_right(int citizen, string str);

        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_check_right_allW")]
        ...
        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_server_adminW")]
        ...
        [DllImport("aw", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_avatar_locationW")]
